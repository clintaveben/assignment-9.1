...
# Q)  2. Suppose p = the proportion of students who are admitted to the graduate school
...
#by calculations it is clear that our test statistic is not less 
#than -2.326348 
#So we accept our null hypothesis Ho
#hence we say that the observed data are consistent with 
#the officer's claim at alpha = 0.01(Level of Significance)
